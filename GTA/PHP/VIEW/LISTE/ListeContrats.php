...
echo '<div class="bigEspace"></div>';
 echo '<div class="grid-columns-span-7"><div class="demi"></div><input name="filtre" title="entrer le mot à chercher puis cliquer sur le filtre" placeholder="mot à chercher"/><i class="fa-solid fa-filter" title="entrer le mot à chercher puis cliquer sur le filtre"></i><div class="demi"></div></div>';
...
echo '<template>';
echo '<div class="donnees ">IdCentre</div>';
echo '<div class="donnees ">IdUtilisateur</div>';
echo '<div class="donnees ">DateDebutContrat</div>';
echo '<div class="donnees ">DateFinContrat</div>';
 echo '<a href="index.php?page=FormContrats&mode=Afficher&id=IdContrat"><i class="fas fa-file-contract"></i></a>';
                                    
echo '<a href="index.php?page=FormContrats&mode=Modifier&id=IdContrat"><i class="fas fa-pen"></i></a>';
                                    
echo '<a href="index.php?page=FormContrats&mode=Supprimer&id=IdContrat"><i class="fas fa-trash-alt"></i></a>';
 echo '</template>';
