...
$objets = View_MotifsManager::getList(null, null, null, Parametres::getNbEltParPage());
...
<div class="caseListe"><a href="index.php?page=FormView_Motifs&mode=Ajouter"><i class="fas fa-plus"></i></a></div>
<div></div>
</div>';
