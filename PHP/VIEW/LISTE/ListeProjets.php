...
echo '<div class="caseListe labelListe " data-name= "CodeProjet">'.texte("CodeProjet").'</div>';
echo '<div class="caseListe labelListe left" data-name= "LibelleProjet">'.texte("LibelleProjet").'</div>';
