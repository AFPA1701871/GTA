...
echo '<div class="caseListe titreListe grid-columns-span-5">Liste des Projets </div>';
echo '<div class="bigEspace"></div>';
...
echo '<div class="caseListe labelListe left" data-name= "LibelleProjet">LibelleProjet</div>';
