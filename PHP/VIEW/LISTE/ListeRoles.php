...
echo '<div class="donnees ">NomRole</div>';
 echo '<a href="index.php?page=FormRoles&mode=Afficher&id=IdRole"><i class="fas fa-file-contract"></i></a>';
                                    
echo '<a href="index.php?page=FormRoles&mode=Modifier&id=IdRole"><i class="fas fa-pen"></i></a>';
                                    
echo '<a href="index.php?page=FormRoles&mode=Supprimer&id=IdRole"><i class="fas fa-trash-alt"></i></a>';
 echo '</template>';
