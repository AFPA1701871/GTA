...
echo '<div class="caseListe titreListe grid-columns-span-4">Liste des Fermetures </div>';
echo '<div class="bigEspace"></div>';
...
echo '<div class="caseListe labelListe" data-name= "DateFermeture">DateFermeture</div>';
