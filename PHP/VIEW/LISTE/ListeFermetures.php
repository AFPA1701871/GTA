...
echo '<div class="bigEspace"></div>';
 echo '<div class="grid-columns-span-4"><div class="demi"></div><input id=searchInList  title="'.texte("infoSearch").' placeholder="'.texte("mot à chercher").'/><i class="fa-solid fa-search" title="entrer le mot à chercher puis cliquer sur le filtre"></i><div class="demi"></div></div>';
echo '<div class="caseListe grid-columns-span-4">
<div></div>
<div class="bigEspace"></div>
<div class="caseListe"><a href="index.php?page=FormFermetures&mode=Ajouter"><i class="fas fa-plus"></i></a></div>
<div></div>
</div>';
...
echo '<template>';
echo '<div class="donnees ">DateFermeture</div>';
 echo '<a href="index.php?page=FormFermetures&mode=Afficher&id=IdFermeture"><i class="fas fa-file-contract"></i></a>';
                                    
echo '<a href="index.php?page=FormFermetures&mode=Modifier&id=IdFermeture"><i class="fas fa-pen"></i></a>';
                                    
echo '<a href="index.php?page=FormFermetures&mode=Supprimer&id=IdFermeture"><i class="fas fa-trash-alt"></i></a>';
 echo '</template>';
