...
echo '<div class="caseListe titreListe grid-columns-span-5">Liste des Uos </div>';
echo '<div class="bigEspace"></div>';
...
<div class="caseListe"><a href="index.php?page=FormUos&mode=Ajouter"><i class="fas fa-plus"></i></a></div>
<div></div>
</div>';

echo '<div class="caseListe labelListe" data-name= "NumeroUO">NumeroUO</div>';
echo '<div class="caseListe labelListe left" data-name= "LibelleUO">LibelleUO</div>';
...
echo '<div class="donnees left">LibelleUO</div>';
 echo '<a href="index.php?page=FormUos&mode=Afficher&id=IdUO"><i class="fas fa-file-contract"></i></a>';
                                    
echo '<a href="index.php?page=FormUos&mode=Modifier&id=IdUO"><i class="fas fa-pen"></i></a>';
                                    
echo '<a href="index.php?page=FormUos&mode=Supprimer&id=IdUO"><i class="fas fa-trash-alt"></i></a>';
 echo '</template>';
