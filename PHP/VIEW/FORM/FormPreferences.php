...
if (isset($_GET['id'])) {
	$elm = PreferencesManager::findById($_GET['id']);
} else {
	$elm = new Preferences();
}
echo '<main class="center">';

echo '<form class="GridForm" action="index.php?page=ActionPreferences&mode='.$_GET['mode'].'" method="post"/>';
echo '<div class="bigEspace"></div>	';
echo '<div class="caseForm titreForm col-span-form">Formulaire Preferences</div>';
...
echo '<div class="caseForm col-span-form">
	<div></div>
	<div><a href="index.php?page=ListePreferences"><button type="button"><i class="fas fa-sign-out-alt fa-rotate-180"></i></button></a></div>
