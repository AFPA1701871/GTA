...
echo '<div class="caseForm donneeForm"><input type="date" '.$disabled .'value="'.date('Y-m-d', strtotime($elm->getDateFermeture())).'" name=DateFermeture pattern="'.$regex["date"].' required"></div>';
