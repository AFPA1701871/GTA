...
echo '<div class="caseForm titreForm col-span-form">Formulaire View_Pointages_Satellites</div>';
...
echo '<div class="caseForm col-span-form">
	<div></div>
	<div><a href="index.php?page=ListeView_Pointages_Satellites"><button type="button"><i class="fas fa-house fa-rotate-180"></i></button></a></div>
	<div class="cote"></div>';
