...
echo '<div class="caseForm titreForm col-span-form">'.texte("Formulaire View_Utilisateurs").'</div>';
...
echo '<div class="caseForm col-span-form">
	<div></div>
	<div><a href="index.php?page=ListeView_Utilisateurs"><button type="button"><i class="fas fa-sign-out-alt fa-rotate-180"></i></button></a></div>
