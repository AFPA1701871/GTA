...
echo '                <!-- Ligne -->';
echo '                <div class="rtt center grid-columns-span-2 fullLine  grid-lineSimple cellBottom left">Nb jours absences&nbsp;<small id="info">ne pas saisir les absences RTT</small></div>';
echo '        <!--------------------------->';
...
echo '                        <div class="expand-line vMini border-left"><i class="fas fa-open" data-line="1-1"></i></div>';
echo '                    </div>';
...
echo '                        </select>';
echo '                        <div class="favorise vMini cellRight"><i class="fas fa-fav"></i></div>';
echo '                        <div class="expand-line vMini"><i class="fas fa-open border-left" data-line="2-1"></i></div>';
echo '                    </div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">Cde Prest.</div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">UO de MAD</div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">Code Motif</div>';
...
echo '                        </select>';
echo '                        <div class="favorise vMini cellRight"><i class="fas fa-fav"></i></div>';
echo '                        <div class="expand-line vMini"><i class="fas fa-open border-left" data-line="3-1"></i></div>';
echo '                    </div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">Cde Prest.</div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">UO de MAD</div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">Code Motif</div>';
...
echo '                        </select>';
echo '                        <div class="favorise vMini cellRight"><i class="fas fa-fav"></i></div>';
echo '                        <div class="expand-line vMini"><i class="fas fa-open border-left" data-line="4-1"></i></div>';
echo '                    </div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">Cde Prest.</div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">UO de MAD</div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">Code Motif</div>';
...
echo '                        </select>';
echo '                        <div class="favorise vMini cellRight"><i class="fas fa-fav"></i></div>';
echo '                        <div class="expand-line vMini"><i class="fas fa-open border-left" data-line="5-1"></i></div>';
echo '                    </div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">Cde Prest.</div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">UO de MAD</div>';
echo '                    <div class="center grid-lineSimple colCachable noDisplay cellBottom cellRight">Code Motif</div>';
...
echo '                <div class="cellBottom center grid-lineSimple border-left"></div>';
