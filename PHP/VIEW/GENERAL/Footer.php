<footer class="center">
    <div class="cote"></div>
    <div class="center">
        <?php echo ((isset($_SESSION['utilisateur']) && $nom != 'ChangePassword') ? '<a class="easter" href="?page=Easter"><img src="./IMG/death-star.svg" alt=""></a>' : ''); ?>
    ...
    if ($matches != null) {
        if ($matches[0] == "Liste") {
            ...
            if ($page[1] == "FormPointages") {
                ...
                echo '<script src="./JS/Modale.js"></script>';
            }
        }
    }
    switch ($page[1]) {
